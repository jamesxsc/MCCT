...
public class LocationUtil {
    ...
    public boolean is(int x, int y, int z, World world, int x2, int y2, int z2, World world2) {
        return x == x2 &&
                y == y2 &&
                z == z2 &&
    ...
    public boolean is(PowerBlock pb, Location toCompare) {
        return this.is(pb.getX(), pb.getY(), pb.getZ(), pb.getWorld(),
